    ...
    <s-page heading="Bundle rules">
      ...
      <s-section heading="Overview">
        <s-stack direction="inline" gap="base">
          ...
          <s-box padding="base" borderWidth="base" borderRadius="base">
            <s-heading>
              {rules.reduce((total, rule) => total + rule.successfulAddsToCart, 0)}
            </s-heading>
      ...
      <s-section heading="Rules">
        {rules.length === 0 ? (
          <s-stack direction="block" gap="base">
            <s-paragraph>
              Create your first mix-and-match bundle to combine collections, products, and SKUs.
            </s-paragraph>
                ...
                <div style={{ display: "grid", gap: "0.75rem" }}>
                  ...
                  >
                    <div>
                      ...
                      <s-paragraph>
                        {rule.status === "active" ? "Active" : "Draft"} · {rule.groups.length}{" "}
                        groups ·{" "}
                    ...
                    >
                      ...
                      <Form method="post">
                        ...
                        <input
                          type="hidden"
                          name="intent"
                          value={rule.status === "active" ? "deactivate" : "activate"}
                        />
                        <button type="submit">
                  ...
                  <s-paragraph>{rule.groups.map((group) => group.title).join(" + ")}</s-paragraph>
                </div>
              </s-box>
            ))}
          </div>
      ...
      <s-section slot="aside" heading="Runtime status">
        <s-paragraph>
          Active rules are exposed to the PDP widget API and discount-function runtime config.
        </s-paragraph>
      </s-section>
    </s-page>
  );
