...
Default to single-shot delivery: when asked to plan or implement, optimise for one comprehensive task that lands as one pull request (doesn't mean one commit!). Avoid splitting into many micro tasks or PRs unless explicitly required.
